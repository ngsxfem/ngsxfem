...
tracesource exp(50*(x-R))

linearform f -fespace=tracefes
tracesource 10*exp(50*(x-R))
...
numproc parabolic3d np1 -bilinearforma=a -bilinearformm=m -linearform=f -visnumproc=npto -gridfunction=u -dt=0.02 -tend=7 -periodic_rhs=7
