...
define fespace v -type=h1ho -order=1
...
define coefficient initialvals
(
(sqrt((x-0.3)*(x-0.3)+(y-0.5)*(y-0.5)+(z-0.5)*(z-0.5))-0.25 < sqrt((x-0.7)*(x-0.7)+(y-0.5)*(y-0.5)+(z-0.5)*(z-0.5))-0.25) 
* (sqrt((x-0.3)*(x-0.3)+(y-0.5)*(y-0.5)+(z-0.5)*(z-0.5))-0.25) 
+
(sqrt((x-0.3)*(x-0.3)+(y-0.5)*(y-0.5)+(z-0.5)*(z-0.5))-0.25 > sqrt((x-0.7)*(x-0.7)+(y-0.5)*(y-0.5)+(z-0.5)*(z-0.5))-0.25) 
* (sqrt((x-0.7)*(x-0.7)+(y-0.5)*(y-0.5)+(z-0.5)*(z-0.5))-0.25)
),
...
numproc meancurv np1 -bilinearforma=a -bilinearformm=m -gridfunction=u -dt=0.0005 -tend=0.025 #-stop_after_step
