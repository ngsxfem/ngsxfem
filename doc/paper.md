...
A more detailed overview of the key features provided by `ngsxfem` can be found in the repository under `docu/feature-details.md` Furthermore, a detailed overview of the scientific literature which has utilised `ngsxfem` is given in the repository under `docu/literature.md`
