...
Draw(triangle.Indicator(level_sets_p1), mesh, "triangle")
Draw(triangle.Boundary().IndicatorSomoothed(level_sets_p1), mesh, "bnd")
Draw(triangle.Boundary().Boundary().IndicatorSomoothed(level_sets_p1), mesh, "cnr")
