...
Given a level set function \phi which describes the geometry (e.g. \Omega = \{ \phi < 0 \}) a piecewise linear approximation is made. On simplices (triangles and tetrahedra) a decomposition into simple geometries is carried out.
#+html: <p align="center"><img src="doc/graphics/cuttet.jpg" width="450"/><img src="doc/graphics/intpoints.jpg" width="300"/></p>
...
#+html: <p align="center"><img src="doc/graphics/intpoints.jpg" width="300"/></p>

*** Tools to work on an "active mesh" only
#+html: <p align="center"><img src="doc/graphics/unfittedmesh.jpg" width="300"/></p>
