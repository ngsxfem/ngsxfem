...
Given a level set function which describes the geometry a piecewise linear approximation is made. On simplices (triangles and tetrahedra) a decomposition into simple geometries is carried out.
...
#+html: <p align="center"><img src="doc/graphics/intpoint.jpg" width="300"/></p>
