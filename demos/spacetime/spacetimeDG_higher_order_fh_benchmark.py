...
a_gp = BilinearForm(st_fes, "a", check_unused=False)
...
a_gp += SymbolicFacetPatchBFI(form=h**(-2) * delta_t * (1 + delta_t / h) * gamma * (u - u.Other()) * (v - v.Other()),
...
while tend - told.Get() > delta_t / 2:
    ...
    a.mat.AsVector().data = a.mat.AsVector() + a_gp.mat.AsVector()
