...
numproc drawflux npdf1 -bilinearform=evalu_past -solution=u_st -label=u_past
numproc drawflux npdf2 -bilinearform=evalu_future -solution=u_st -label=u_future
